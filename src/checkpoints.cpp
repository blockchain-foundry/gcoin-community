...
// TODO: it's bitcoin's checkpoint so we invalidate it now ,we must modify to gcoin's checkpoint future.
...
const CCheckpointData &Checkpoints()
{
    if (Params().NetworkID() == CBaseChainParams::TESTNET)
        return dataTestnet;
    else if (Params().NetworkID() == CBaseChainParams::MAIN || Params().NetworkID() == CBaseChainParams::GCOIN)
        return data;
    else
        return dataRegtest;
}

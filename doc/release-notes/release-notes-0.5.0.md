...
If you have a previously encrypted wallet.dat, the first time you run bitcoin-qt or gcoind the wallet will be rewritten, Bitcoin will
...
gcoind: run the 'walletpassphrase' RPC command to unlock the wallet,  then run the 'getnewaddress' RPC command.
